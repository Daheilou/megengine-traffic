...
#         ann_file = ann_file.replace('traffic5/traffic5','traffic5/')
        ann_file = ann_file.replace('traffic5','')
...
#                 path = path.replace('traffic5/traffic5','traffic5/')
                path = path.replace('traffic5','')
